...
return {
	enter = function(self)
		...
		stageBack = Image(love.graphics.newImage(graphics.imagePath("week6/weebSky")))
		stageFront = Image(love.graphics.newImage(graphics.imagePath("week6/weebSchool")))
		curtains = Image(love.graphics.newImage(graphics.imagePath("week6/weebStreet")))
	...
	initUI = function(self)
		...
		if songNum == 3 then
			weeks:generateNotes(love.filesystem.load("charts/week6/thorns" .. songAppend .. ".lua")())
		elseif songNum == 2 then
			weeks:generateNotes(love.filesystem.load("charts/week6/roses" .. songAppend .. ".lua")())
		else
			weeks:generateNotes(love.filesystem.load("charts/week6/senpai" .. songAppend .. ".lua")())
		end
	end,
